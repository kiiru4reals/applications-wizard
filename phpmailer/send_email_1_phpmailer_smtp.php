...
<head>
    ...
    <title>Applications | Just a job application wizard.</title>
...
try {
    ...
    $mail->addAddress('hr@jobapplications.co.ke', 'Job Applications at Job Applications');                             // Email Address and Name TO - Name is optional
