...
<head>
	...
	<title>Applications | Just an application wizard</title>
...
<body style="background-color:#fff;" onLoad="setTimeout('delayedRedirect()', 5000)">
	...
	$to = "hr@jobapplciation.co.ke";/* YOUR EMAIL HERE */
	$subject = "Job application from Job applications";
	$headers = "From: Job application from Application <noreply@jobapplication.co.ke>";
	...
	if (isset($_FILES['fileupload'])) {
		...
		if (empty($errors) == true) {
			...
			$message .= "\nResume: http://applications.jobapplications.co.ke/upload_files/" . $FinalFilename; // Write here the path of your upload_files folder
		} else {
	...
	$userheaders = "From: Job application from Job applications <noreply@jobapplications.co.ke>";
